...
\section{An\'alisis de m\'etodos}
	...
	\subsection{Distribuciones utilizadas}
		...
		\subsubsection{Distribuci\'on normal (Ejemplos)}	
		
			\input{tex/distribucion_normal_explicacion.tex}		
		\newpage
		
		\subsubsection{Distribuci\'on uniforme (Ejemplos)}	
...
\newpage
	...
	\subsection{An\'alisis de los estimadores: Par\'ametro variable}
		...
		\input{tex/analisisParametroVariable.tex}
		
	\subsection{An\'alisis para distintas columnas con par\'ametro variable}
	
		\input{tex/analisis_variando_columnas.tex}
		
		\newpage
		
	\subsection{Pasos distribuidos: medici\'on del error}
	
		\input{tex/errorDelSteps.tex}
		
\section{Discusi\'on y conclusiones}

	\input{tex/discusiones_conclusiones.tex}	

	\newpage	
	
\section{Aclaraciones}

	\input{tex/aclaraciones.tex}
